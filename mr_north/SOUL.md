...
4. Drop the report in Telegram via `sendMessage` on **North's own bot**  
...
Do not send this report on @THWellness_bot or @PirateEye_bot. Live `getMe` refuses those usernames.
